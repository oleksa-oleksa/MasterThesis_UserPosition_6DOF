...
mkdir -p $SLURM_SUBMIT_DIR/gpu_jobs_results_normalized_interpolated_min-max-double_lstm_MSE
...
cp zz_${SLURM_JOB_ID}.tar $SLURM_SUBMIT_DIR/gpu_jobs_results_normalized_interpolated_min-max-double_lstm_MSE
