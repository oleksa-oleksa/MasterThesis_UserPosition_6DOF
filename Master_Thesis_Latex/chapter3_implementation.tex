...
The best performance was achieved without additional activation functions with simple one-layered architecture represented below:
...
LSTMModel2                   [128, 20, 7]              --
	--- LSTM: 1-1        [128, 20, 512]            1,073,152
	--- Mish: 1-2        [128, 20, 512]            --
	--- Linear: 1-3      [128, 20, 1024]           525,312
	--- Mish: 1-4        [128, 20, 1024]           --
	--- Linear: 1-5      [128, 20, 7]              7,175
==================================================================
...
GRU model implementation, training loop and evaluation are done similar to LSTM in Python using PyTorch. Model has same input $[batch, sequence, features]$ with sequence equal to 20 last values and 10 features (3 positional, 4 rotation and 3 velocity columns). The batch size was increased to $2^{9}$. The hidden dimension  is 512 nodes. Adam optimization algorithm is used, the learning rate was decreased by 60\% from initial value of 0.0001 every 50 epochs. Thus parameters of adjustable learning rate are modified. Weight decay of Adam optimiser set to a same value of $1e-12$ . 
