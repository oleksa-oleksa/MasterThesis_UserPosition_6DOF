...
The correct chosen model can discover and learn the patterns in the input dataset while being trained in order to predict a new data after training. The sections \ref{sec:impl:dataset:explor} and \ref{sec:impl:dataset:preprocessing} describes how the dataset, used as input, was obtained and 
