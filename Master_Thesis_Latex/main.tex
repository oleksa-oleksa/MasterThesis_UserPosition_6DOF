...
\newcommand{\thesisTitleEng}{\Large User position prediction in 6-DoF mixed reality applications}
\newcommand{\thesisTitleDe}{\large Vorhersage der Benutzerposition in 6-DoF-Mixed-Reality-Anwendungen}
\newcommand{\thesisName}{Oleksandra Baga}
\newcommand{\thesisDate}{05.06.2022}
%\newcommand{\thesisVersion}{Final}

\newcommand{\thesisFirstReviewer}{Prof. Dr. Christian Forler}
...
\newcommand{\thesisSecondReviewer}{Prof. Dr. René Görlich}
...
\input{chapter2_theorie}
\input{chapter3_design}
\input{chapter4_Implementation}
\input{chapter5_results_conclusion}
\input{chapter7_appendix}
